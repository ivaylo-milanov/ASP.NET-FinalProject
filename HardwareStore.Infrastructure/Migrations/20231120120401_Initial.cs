        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "order phone"),
                    ...
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "order customer id")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "characteristic product id"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "favorite user id"),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "favorite product id")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "product order product id"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "shopping cart item customer id"),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "shopping cart item product id"),
